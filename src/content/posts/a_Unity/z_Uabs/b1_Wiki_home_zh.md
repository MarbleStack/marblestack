...
👉 Translate to [English](/marblestack/posts/a_unity/z_uabs/b_wiki_home/)
...
> **UABS**是一款针对Unity游戏引擎的资源模组工具。它可以帮助模组制作者快速查找，浏览，管理游戏资源和资源包。

<br>

## 📖 概览

该维基是 UABS 的文档中心。在这里，你可以找到了解、使用和参与该项目所需的一切信息。
...
如果你重新发布或修改此工具，请注明作者或附上此repo的链接。
